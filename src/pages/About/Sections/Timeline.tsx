...
export default function Timeline() {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-50/80 py-24 sm:py-32" id="timeline">
      ...
      <Container>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base leading-relaxed text-slate-600 sm:text-lg">
            From our founding in Bhandup in 2021 to emerging as a premier integrated MEP, Solar & Fire Safety engineering partner — explore our key milestones of consistent quality and growth.
          </p>
            ...
            {filteredMilestones.map((item, index) => {
              ...
              return (
                <div
                  ...
                  className={`relative flex flex-col transition-all duration-700 ease-out lg:flex-row ${
                ...
                >
                  ...
                  {/* Content Box (Left or Right on desktop, right side on mobile) */}
                  <div
